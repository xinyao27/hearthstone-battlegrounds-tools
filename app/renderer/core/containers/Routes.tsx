...
const LazyRecordPage = React.lazy(
  () => import(/* webpackChunkName: "RecordPage" */ '@core/pages/record')
);
...
const LazyStatisticsPage = React.lazy(
  () =>
    import(/* webpackChunkName: "StatisticsPage" */ '@core/pages/statistics')
);
...
const LazySettingsPage = React.lazy(
  () => import(/* webpackChunkName: "SettingsPage" */ '@core/pages/settings')
);
